...
SET @book_id = NEWID();
INSERT INTO book_metadata (metadata_id, genre_id, title, sypnosis, author, copyright, cover, publisher, publication_date, added_on, isbn, edition_str, edition_num) VALUES (@book_id, 2, 'The Hobbit', 'A fantasy tale in which a hobbit sets out to regain a stolen treasure called the rings.', 'J.R.R. Tolkien', 'Copyright 2002', '../../../resources/assets/defaults/books/The Hobbit.jpg', 'HMH Books for Young Readers', '2002-02-28', '2023-06-16', '9780618260300', 'First Edition', 1);
...
SET @book_id = NEWID();
INSERT INTO book_metadata (metadata_id, genre_id, title, sypnosis, author, copyright, cover, publisher, publication_date, added_on, isbn, edition_str, edition_num) VALUES (@book_id, 6, 'The Chronicles of Narnia', 'A series of fantasy novels set in the magical land of Narnia.', 'C.S. Lewis', 'Copyright 2002', '../../../resources/assets/defaults/books/The Chronicles of Narnia.jpg', 'HarperCollins', '2002-10-01', '2023-06-16', '9780064471190', 'First Edition', 1);
...
SET @book_id = NEWID();
INSERT INTO book_metadata (metadata_id, genre_id, title, sypnosis, author, copyright, cover, publisher, publication_date, added_on, isbn, edition_str, edition_num) VALUES (@book_id, 8, 'The Mysterious Island', 'The book tells the adventures of five American prisoners of war on an uncharted island in the South Pacific.', 'Jules Verne', 'Copyright 2004', '../../../resources/assets/defaults/books/The Mysterious Island.jpg', 'Modern Library', '2004-08-28', '2023-06-16', '9780812972122', 'First Edition', 1);
...
SET @book_id = NEWID();
INSERT INTO book_metadata (metadata_id, genre_id, title, sypnosis, author, copyright, cover, publisher, publication_date, added_on, isbn, edition_str, edition_num) VALUES (@book_id, 14, 'The Book Thief', 'A story about a girl who steals books during World War II.', 'Markus Zusak', 'Copyright 2007', '../../../resources/assets/defaults/books/The Book Thief.jpg', 'Knopf Books for Young Readers', '2007-03-14', '2023-06-16', '9780375842207', 'First Edition', 1);
...
SET @book_id = NEWID();
INSERT INTO book_metadata (metadata_id, genre_id, title, sypnosis, author, copyright, cover, publisher, publication_date, added_on, isbn, edition_str, edition_num) VALUES (@book_id, 15, 'The Da Vinci Code', 'A thriller involving a symbologist and a conspiracy involving the Holy Grail.', 'Dan Brown', 'Copyright 2018', '../../../resources/assets/defaults/books/The Da Vinci Code.jpg', 'Corgi', '2018-04-01', '2023-06-16', '9780307474278', 'First Edition', 1);
